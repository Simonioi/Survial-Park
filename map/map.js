...
(function() {
    ...
    function startGame() {
        ...
        // Load camera position from localStorage if available
        ...
        if (savedScore) {
            ...
            console.log(`✓ Restored score from previous session`);
        }
    ...
    function loadNPCsFromLocalStorage() {
        ...
        console.log(`✓ Loaded ${npcPositions.length} NPCs from dev mode`);
    }
